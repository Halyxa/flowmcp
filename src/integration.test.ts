...
describe("MCP Protocol Integration", () => {
  ...
  it("includes all expected tool names", async () => {
    ...
    const expected = [
      ...
      "flow_cluster_data",
      "flow_hierarchical_data",
      "flow_compare_datasets",
      "flow_pivot_table",
      ...
      "flow_guided_tour",
      "flow_famous_network",
      "flow_quest_generator",
      "flow_anomaly_explain",
      "flow_near_miss_detector",
      "flow_progressive_disclosure",
      "flow_insight_scorer",
      "flow_waypoint_map",
      "flow_visor_mode",
      "flow_sparkle_engine",
      "flow_exploration_dna",
      "flow_data_world_builder",
      "flow_generate_synthetic",
      "flow_fog_of_war",
      "flow_explorer_profile",
      "flow_viral_video_spec",
      "flow_discovery_narrator",
    ];
