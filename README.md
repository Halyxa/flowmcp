...
The world's first AI-to-3D data visualization bridge. An MCP server with **57 tools** that lets any AI assistant transform raw data into interactive 3D spatial visualizations via [Flow Immersive](https://flowimmersive.com).

**836 tests. Zero competitors in 3D viz MCP.**
...
Health check: `GET /health` returns `{"status":"ok","tools":57,"transport":"streamable-http"}`
